...
{
    /// <summary>
    /// Migration to add authentication tables: auth_users, auth_roles, auth_user_roles, auth_refresh_tokens.
    /// Also seeds the default Admin, User, and PremiumUser roles.
    /// </summary>
